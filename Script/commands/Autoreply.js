...
module.exports.handleEvent = async function ({ api, event }) {
  ...
  const responses = {
    "miss you": "অরেক বেডারে Miss না করে xan মেয়ে হলে বস Noyon রে হাঙ্গা করো😶👻😘",
    ...
    "thanks": "এতো ধন্যবাদ না দিয়ে আমার বস Noyon রে তোর গার্লফ্রেন্ড টা দিয়ে দে..!🐸🥵",
    "i love you": "মেয়ে হলে আমার বস Noyon এর ইনবক্সে এখুনি গুঁতা দিন🫢😻",
    "love you": "ভালোবাসা নামক আবলামী করতে চাইলে Boss Noyon এর ইনবক্সে গুতা দিন 😘",
    ...
    "breakup": "চিন্তা করিস না… noyon বস তো আছেই তোকে নতুন জন দিয়া দিবে 😎🔥",
    "tui ke": "আমি তোর বস noyon এর ChatBot 😏",
    "umm": "এতো Umm কেনো জানু… কিছু বলবা? 😉",
    "hmm": "Hmmm কিসের হুমম জানু 🥵",
    "love": "Love করলে সরাসরি noyon বস কে বল জানু 😻🔥"
  };
